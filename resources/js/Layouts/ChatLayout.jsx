...
const ChatLayout = ({ children }) => {
    // provides access to the current page data
    const page = usePage();
    const conversations = page.props.conversations;
    const selectedConversation = page.props.selectedConversation;
    // updated whenever the conversations received
    const [localConversations, setLocalConversations] = useState([]); //array
    const [sortedConversations, setSortedConversations] = useState([]); //array
        ...
        setSortedConversations(
            localConversations.sort((a, b) => {
                ...
                if (a.last_message_date && b.last_message_date) {
                    return a.last_message_date.localeCompare(
                        b.last_message_date
                    );
                        ...
                        {sortedConversations &&
                            sortedConversations.map((conversation) => (
                                <ConversationItem
                                    ...
                                    online={isUserOnline(conversation.id)} // passing boolean
